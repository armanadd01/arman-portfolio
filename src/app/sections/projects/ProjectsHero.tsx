    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pt-20 pb-12">
        <div className="max-w-3xl">
          ...
          <Reveal delay={0.05}>
            <h1 className="font-display mt-6 text-4xl font-semibold leading-[1.06] tracking-[-0.03em] text-foreground sm:text-6xl">
              Selected{" "}
              <span
          ...
          <Reveal delay={0.1}>
            <p className="mt-5 max-w-2xl text-sm leading-7 text-muted">
              A collection of technical challenges, creative experiments, and
              enterprise solutions built with modern web standards.
            </p>
          </Reveal>
        </div>
      </div>
